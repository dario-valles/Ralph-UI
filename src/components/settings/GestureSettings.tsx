          ...
          <div className="space-y-2">
            ...
            <div className="bg-muted/50 rounded-lg p-3 space-y-2 text-sm">
              <div className="flex gap-2">
                ...
                <span className="text-muted-foreground">Recalls the previous command (like pressing ↑)</span>
              </div>
              <div className="flex gap-2">
                <span className="font-medium min-w-[60px]">↓ Swipe Down:</span>
                <span className="text-muted-foreground">Recalls the next command (like pressing ↓)</span>
              </div>
