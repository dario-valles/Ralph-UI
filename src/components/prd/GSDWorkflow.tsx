...
import type { RoadmapDoc, VerificationHistorySummary, PrdExecutionConfig } from '@/types/planning'
import { validateExecutionConfig, hasAnyExecutionConfigFields } from '@/types/planning'
import { Rocket, FileText, ArrowLeft, ArrowRight, Loader2, Settings, AlertTriangle, HelpCircle } from 'lucide-react'
...
export function GSDWorkflow({
  ...
  const handleExport = useCallback(async () => {
    ...
    // Validate execution config if any fields are set
    const configToUse = hasAnyExecutionConfigFields(exportState.executionConfig)
      ? exportState.executionConfig
      : undefined

    if (configToUse) {
      const validationError = validateExecutionConfig(configToUse)
      if (validationError) {
              ...
              <div className="border-t pt-4 mt-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => setExportState((s) => ({ ...s, showSettings: !s.showSettings }))}
                  >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => setExportState((s) => ({
                            ...s,
                            executionConfig: { ...s.executionConfig, agentType: e.target.value || undefined }
                          }))}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setExportState((s) => ({
                            ...s,
                            executionConfig: { ...s.executionConfig, model: e.target.value || undefined }
                          }))}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setExportState((s) => ({
                            ...s,
                            executionConfig: { ...s.executionConfig, maxIterations: e.target.value ? parseInt(e.target.value) : undefined }
                          }))}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setExportState((s) => ({
                            ...s,
                            executionConfig: { ...s.executionConfig, maxCost: e.target.value ? parseFloat(e.target.value) : undefined }
                          }))}
                      ...
                      <Tooltip content="Run tests after each iteration to verify changes" side="top">
                        <label className="flex items-center gap-2 text-sm cursor-pointer">
                          <input
                            ...
                            onChange={(e) => setExportState((s) => ({
                              ...s,
                              executionConfig: { ...s.executionConfig, runTests: e.target.checked || undefined }
                            }))}
                          />
                          <span>Run Tests</span>
                        </label>
                      ...
                      <Tooltip content="Run linter after each iteration" side="top">
                        <label className="flex items-center gap-2 text-sm cursor-pointer">
                          <input
                            ...
                            onChange={(e) => setExportState((s) => ({
                              ...s,
                              executionConfig: { ...s.executionConfig, runLint: e.target.checked || undefined }
                            }))}
                          />
                          <span>Run Lint</span>
                        </label>
                      ...
                      <Tooltip content="Run in a git worktree for isolation" side="top">
                        <label className="flex items-center gap-2 text-sm cursor-pointer">
                          <input
                            ...
                            onChange={(e) => setExportState((s) => ({
                              ...s,
                              executionConfig: { ...s.executionConfig, useWorktree: e.target.checked }
                            }))}
                          />
