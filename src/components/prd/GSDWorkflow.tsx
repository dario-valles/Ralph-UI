...
import { ExportPhase, type ExportPhaseState } from './gsd/ExportPhase'
...
/**
 * Export dialog state for final step
 */
type ExportDialogState = ExportPhaseState & {
  isOpen: boolean
}
      ...
      case 'export':
        return (
          <ExportPhase
            ...
            onExportStateChange={(update) => setExportState((s) => ({ ...s, ...update }))}
