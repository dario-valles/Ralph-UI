...
import { DiffInfo, FileDiff, gitApi, gitHelpers } from '../../lib/api/git-api'
    ...
    <Card className="w-full">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
        <div>
          ...
          {diff && <div className="text-sm text-gray-600">{gitHelpers.getDiffSummary(diff)}</div>}
        </div>
      ...
      <CardContent>
        ...
        {loading && !diff && <div className="text-center py-8 text-gray-500">Loading diff...</div>}
                  ...
                  <div key={index} className="border rounded-lg overflow-hidden">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="flex items-center space-x-2">
                            <span className="font-medium font-mono text-sm">{filePath}</span>
                        ...
                        <div className="text-sm text-gray-600">
                          ...
                          {file.old_path && (
                            <p>
                              ...
                              <code className="bg-gray-100 px-2 py-1 rounded">{file.old_path}</code>
                            </p>
                          )}
                          {file.new_path && (
                            <p>
                              <strong>New Path:</strong>{' '}
                              <code className="bg-gray-100 px-2 py-1 rounded">{file.new_path}</code>
                            </p>
                          )}
                          <p>
